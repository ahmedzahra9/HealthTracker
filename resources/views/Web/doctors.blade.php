                ...
                <form action="">
                    <div class="select-div p-4 z-depth-1">
                        <div class="form-group w-100">
                            <label for="">
                                <i class="fal fa-bookmark"></i>إختر الطبيب
                            </label>
                            <select name="" class="select2" id="category_id">
                                <option value="" disabled selected> يرجى إختيار التخصص </option>
                                @foreach($all_categories as $category)
                                    <option {{$category->id == $selected_category?'selected':''}} value="{{$category->id}}">{{$category->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <a href="{{url('doctors')}}" style="padding: 20px" class="btn chose-doctor-search doctor_form"> بحث عن
                            طبيب</a>
                    </div>
                </form>
                <form action="">
                    <div class="select-div doctor-filter p-4 z-depth-1 justify-content-between">
                        ...
                        <div class="form-group">
                            <select name="" class="select2" id="rate">
                                ...
                                <option {{$selected_rate=='desc'?'selected':''}} value="desc"> الاعلى تقييما </option>
                            </select></div>
                        <div class="form-group">
                            <select name="" class="select2" id="location_ar">
                                ...
                                <option {{$selected_location_ar=='desc'?'selected':''}} value="desc"> الابعد </option>
                            </select>
                        </div>
                    </div>
                </form>
