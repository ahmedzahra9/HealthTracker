...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('hospitals.store')}}">
    ...
    <div class="row mt-0">
        ...
        <div class="d-flex flex-column mb-2 fv-row col-md-6 mt-0">
            ...
            <!--end::Label-->
            <input type="email" class="form-control form-control-solid" placeholder="البريد الالكترونى" name="email" value=""/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-md-6 mt-0">
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            ...
            <!--end::Label-->
            <textarea type="text" class="form-control form-control-solid" placeholder="الوصف ( بالعربية )" name="description" ></textarea>
        </div>
        <!--end::Input group-->
